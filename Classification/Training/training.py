...
class training(object):
	...
	def train(self):
		...
		#w/out data_aug
			...
			# H = model.fit(x=trainX, y=trainY, batch_size=100, epochs=5)
		...
		modelName = 'Results/results/'+destino+'/model/Ex'+str(self.numberOfExperiment)
		modelName = modelName+self.save_to_dir_model
